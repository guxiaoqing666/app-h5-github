...
export function createDefaultProfile(userId: string): Profile {
  return {
    ...
    political_status: "",
    work_years: 0,
    target_note: "护理专业优先考虑医疗编、医院护理岗。关注卫健委、医院官网招聘。小香加油！",
  };
}
...
export function createDefaultExams(userId: string): Exam[] {
  ...
  return [
    ...
    },
    {
      ...
      name: "合肥市医疗卫生招聘",
      category: "医疗编",
      target_date: addDays(todayKey(), 60),
      date_status: "pending",
      source_url: "https://www.hfpta.com/",
      notes: "护理专业可报，关注合肥市及各区县卫健委招聘公告。需医学基础+护理专业知识。",
      priority: 1,
    },
    {
      id: randomId(),
      ...
      name: "安徽省立医院/安医附院护理岗",
      category: "护理岗",
      target_date: addDays(todayKey(), 75),
      date_status: "pending",
      source_url: "https://www.ahslyy.com.cn/",
      notes: "三甲医院合同制或编制护理岗，待遇较好，竞争激烈。关注医院官网招聘。",
      priority: 2,
    },
  ];
}
...
export function createDefaultTargetUnits(userId: string): TargetUnit[] {
  return [
    ...
    },
    {
      ...
      commute_score: 4,
      stability_score: 4,
      fit_note: "护理专业对口，事业编制，需医学基础+护理专业知识。关注市卫健委统一招聘。",
      priority: 1,
      status: "watching",
      source_url: "https://www.hfpta.com/",
    },
    {
      ...
      commute_score: 5,
      stability_score: 3,
      fit_note: "工作相对轻松，通勤近，适合求稳。待遇比三甲医院低但压力小。",
      priority: 2,
      status: "watching",
      source_url: "https://www.hfxf.gov.cn/",
    },
